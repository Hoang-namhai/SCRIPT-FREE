...
function OneHit()
setHexMemory("libil2cpp.so", 0x15E9DA4, "E0 03 27 1E C0 03 5F D6")
setHexMemory("libil2cpp.so", 0x15E9F84, "E0 03 27 1E C0 03 5F D6")
gg.toast('✅𝙰𝙲𝚃𝙸𝚅𝙰𝚃𝙴𝙳✅')
end


function GodMod()
setHexMemory("libil2cpp.so", 0x15EA5F4, "E0 03 27 1E C0 03 5F D6")
setHexMemory("libil2cpp.so", 0x15EA7D4, "E0 03 27 1E C0 03 5F D6")
gg.toast('✅𝙰𝙲𝚃𝙸𝚅𝙰𝚃𝙴𝙳✅')
end
